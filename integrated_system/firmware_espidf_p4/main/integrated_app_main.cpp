...
void start_smartcar()
{
    ESP_LOGI(TAG, "starting smart-car patrol subsystem");
    CarDrive.begin();
    Tracer.begin();
    Avoider.begin();
    WebSys.begin(SMARTCAR_AP_SSID, SMARTCAR_AP_PASSWORD);
    WebSys.set_mode(SystemMode::kTrace);
    CarDrive.stop();
}
...
extern "C" void app_main()
{
    ...
    ESP_LOGI(TAG, "integrated system ready: car patrol + AI vision mailbox + robot arm");
